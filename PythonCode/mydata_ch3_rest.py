...
dataset = pd.read_csv(dataset_path + 'mydata_chapter3_result_outliers.csv', index_col=0)
...
selected_predictor_cols = [c for c in dataset.columns if (not ('label' in c)) and (not (c == 'acc_phone_x'))]
...
DataViz.plot_dataset(dataset, ['acc_', 'gyr_',  'mag_', 'press_phone_', 'label'], ['like', 'like', 'like', 'like', 'like'], ['line', 'line', 'line', 'line',   'points'])
